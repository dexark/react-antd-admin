export default {
  ...
  'page.home.articlechartcard.card-title': 'Hurricanes',
  'page.home.workschartcard.card-title': 'Wildfires',
  'page.home.topicschartcard.card-title': 'Tornadoes',
  'page.home.linkschartcard.card-title': 'Floods',

  'page.home.hotsearchcard.card-title': 'Top search',
  'page.home.hotsearchcard.card.table-column-number': 'Number',
  ...
  'page.home.hottagscard.card.table-column-number': 'Number',
  'page.home.hottagscard.card.table-column-name': 'Label',
  'page.home.hottagscard.card.table-column-hit': 'Hits',

  'page.home.articlehitcard.card-title': 'Traffic Ranking',
  'page.home.articlehitcard.card.table-column-number': 'Number',
  ...
  'page.home.workshitcard.card.table-column-number': 'Number',
