...
interface DetailTablePageProps {
  loading: boolean;
  visitData: DetailDataType;
  dispatch: Dispatch;
}

const DetailTablePage: React.FC<DetailTablePageProps> = props => {
  ...
  useEffect(() => {
    dispatch({ type: 'DetailTable/queryDetail' });
  }, [1]);
...
export default connect(
  ({
    ...
    loading: loading.effects['DetailTable/queryDetail'],
    visitData: DetailTable.detail,
  }),
)(DetailTablePage);
